    ...
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Link href={`/cancelar/${reserva.cancelToken}`}>
            <Button variant="outline" className="w-full gap-2 border-brand text-brand hover:bg-brand hover:text-white">
      ...
      <div className="mt-6 bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
        ...
        <div className="mt-4 flex items-center gap-3 text-sm">
          ...
          <a href="tel:+543416880752" className="text-brand hover:text-brand/80">
            3416-880752
          </a>
        </div>
      </div>
      ...
      <div className="mt-6 text-center">
        <Link href="https://taberna.trainera.com.ar" target="_blank" rel="noopener noreferrer">
          <Button variant="link" className="text-brand gap-2">
